...
public class CharacterLiteralToken extends NonNumericLiteralToken {

	public CharacterLiteralToken() {
		super("");
	}
	
	public CharacterLiteralToken(String token) {
		super(token);
	...
	public Token generateCondition(String token, TokenizedCode tokens,
		...
		if (token.startsWith("'") && token.endsWith("'")) {
			return new CharacterLiteralToken(token);
		}
		return null;
	}
