...
public class ElseIfStatementNode extends StatementWithExpressionNode {
	
	public ElseIfStatementNode() {
		super();
	}

	public ElseIfStatementNode(KeywordToken mainToken,
	...
	public ElseIfStatementNode(Node parentNode) {
		super(parentNode);
	}

	public ElseIfStatementNode(ArrayList<Node> childNodes) {
		super(childNodes);
	}

	public ElseIfStatementNode(Node parentNode, ArrayList<Node> childNodes) {
		super(parentNode, childNodes);
	}

	@Override
	public Node generateThisNode(TokenizedCode tokens, Node parent) {
		ElseIfStatementNode statementNode = new ElseIfStatementNode();
